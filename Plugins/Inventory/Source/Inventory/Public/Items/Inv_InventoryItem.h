...
private: //이 부분 GPT 돌려보자 항목 복제해서 서버에 전달하는 곳. 그게 바로 Replicated
	UPROPERTY(VisibleAnywhere, meta = (BaseStruct = "/Script/Inventory.Inv_ItemManifest", DisplayName = "아이템 매니페스트", Tooltip = "이 인벤토리 아이템의 매니페스트 데이터. 모든 프래그먼트 정보를 포함합니다."), ReplicatedUsing = OnRep_ItemState) //인벤토리 아이템 블루프린트 만드는 곳? 파생?
