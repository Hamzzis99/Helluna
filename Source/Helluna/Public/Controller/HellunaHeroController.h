...
public:
	...
	// =========================================================================================
	// [BossDashAttackCheat] 디버그 콘솔 — 보스 돌진 공격 즉시 발동 (대쉬 사망 카메라 테스트용)
	//   사용: PIE 콘솔에서 "BossDashAttack" 입력.
	//   동작: 월드 첫 보스 → GA_Boss_DashAttack grant + 호출 플레이어를 타겟으로 TryActivate.
	//        → 보스가 플레이어 쪽으로 돌진. 돌진 중 처치해 사망 카메라 구도 확인용.
	// =========================================================================================
	...
	UFUNCTION(Server, Reliable)
	void Server_BossDashAttack();

	// =========================================================================================
	// [BossPhase2Cheat] 디버그 콘솔 — 보스 2페이즈 광폭화 시네마틱 즉시 발동
	//   사용: PIE 콘솔에서 "BossPhase2" 입력.
	//   동작: 월드 첫 보스(AHellunaEnemyCharacter_Boss) 찾기 → EnterBossPhase2() 호출(서버 권한).
	//        이미 2페이즈 진입한 보스면 내부 가드(bInPhase2)로 no-op.
	//   Shipping 빌드에서는 body 가 #if UE_BUILD_SHIPPING 가드라 no-op.
	// =========================================================================================
